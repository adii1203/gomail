...
func verifyEmailFormat(email string) (bool, string) {
	...
	userPartLength := len(userPart)
	domainPartLength := len(domainPart)

	if userPartLength > 64 {
		return false, "User part exceeds 64 characters"
	}
